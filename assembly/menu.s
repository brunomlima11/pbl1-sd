...
.global _start
	...
	menu1: #  Label para escrever o conteúdo da LCD (chamada apenas 1 vez por estado)
		...
		movia r14, 0b1001001111
		custom 0, r15, r14, r14
		call minidelay

		movia r14, 0b1001110000
		custom 0, r15, r14, r14
		call minidelay

		movia r14, 0b1010000000
		custom 0, r15, r14, r14
		call minidelay

		movia r14, 0b1011101011
		custom 0, r15, r14, r14
		call minidelay

		movia r14, 0b1001101111
		custom 0, r15, r14, r14
		call minidelay

		movia r14, 0b1000100000
		custom 0, r15, r14, r14
		call minidelay
...
#COMENTARIO PRA VER SE O CODIGO DO ASSEMBLY MUDA COM COMPILACAO

		movia r18, led_addr   # Salva o endereço da variável led_addr no registrador R12
		ldwio r18, 0(r18)     # Lê o conteúdo do endereço de memória salvo (encontrando o endereço do GPIO do LED)
 		movi r9, 0b11111         # Adiciona ao R9 o valor correspondente à combinação de LEDs que deverá ser acesa
		stw r9, 0(r18)
  ...
  menu3:
	...
	sel1:
		...
		movia r14, 0b1001010011
		custom 0, r15, r14, r14
		call minidelay

		movia r14, 0b1001100101
		custom 0, r15, r14, r14
		call minidelay

		movia r14, 0b1001101100
		custom 0, r15, r14, r14
		call minidelay
	...
	loop_sel1:
		...
		ldwio r12, 0(r12)     # Lê o conteúdo do endereço de memória salvo (encontrando o endereço do GPIO do LED)
 		movi r9, 0b11110           # Adiciona ao R9 o valor correspondente à combinação de LEDs que deverá ser acesa
		stwio r9, 0(r12)        # Escreve o valor de R9 na posição de memória do LED
